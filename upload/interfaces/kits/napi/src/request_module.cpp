...
static napi_value err_network_err = nullptr;
...
static void NapiCreateInt32(napi_env env)
{
    ...
    napi_create_int32(env, static_cast<int32_t>(ERROR_NETWORK_ERROR), &err_network_err);
...
static napi_value Init(napi_env env, napi_value exports)
{
    ...
    napi_property_descriptor desc[] = {
        ...
        DECLARE_NAPI_STATIC_PROPERTY("ERROR_NETWORK_ERROR", err_network_err),
